    ...
    def transcribe(
        ...
        *,
        ...
        try:
            ...
            # NamedTemporaryFile keeps the handle locked on Windows, which
            # prevents FFmpeg from reopening browser-uploaded WebM audio.
            ...
            # Reject silence before decoding: short browser recordings otherwise
            # make Whisper hallucinate plausible text in an arbitrary language.
