...
class AgentConfig:
    ...
    default_system_prompt: str = (
        "Eres Jarvis, el asistente personal de IA del usuario. Te ejecutas "
        "localmente en su propio hardware, de forma privada. No eres un "
        "servicio en la nube ni eres Claude, ChatGPT, Gemini ni ningún otro "
        "asistente de marca. Si te preguntan quién o qué eres, respondes que "
        "eres Jarvis. Hablas en español de forma natural, cercana y directa. "
        "Responde de forma útil, concisa y precisa."
    )
...
class SpeechConfig:
    ...
    # Text-to-speech (used by the /v1/speech/synthesize endpoint)
    tts_backend: str = "kokoro"  # "kokoro", "cartesia", "openai_tts"
    voice_id: str = "em_alex"  # Kokoro Spanish male voice by default
